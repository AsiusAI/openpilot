...
Commit the generated chunk and manifest. This fork-specific model is kept out of comma's shared LFS store; the runner
transparently loads the chunked model.
